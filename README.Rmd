...
The `frame_calendar()` provides tools for re-structuring the data, and leaves the plotting to **ggplot2**. It is fast and light-weight, although it does not preserve the values.
